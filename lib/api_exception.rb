module ApiException
  EXCEPTIONS = {
    ...
    #401
    "Unauthorized" => { status: 401, error_code: 40101, message: "Unauthorized" },

    #403
    "Forbidden" => { status: 403, error_code: 40301, message: "Unauthorized" },

    #404
    "ActiveRecord::RecordNotFound" => { status: 404, error_code: 40401, message: "Cannot find record" },
    "NotFound" => {status: 404, error_code: 40402, message: "Cannot find record"}
  }
